...
class Config(object):
    ...
    def _generate_bootloader_build(self, target_overrides, rom_start, rom_size, sectors):
        ...
        if 'target.bootloader_img' in target_overrides:
            ...
            start = Config._align_on_sector(start, sectors)
            part_size = Config._align_on_sector(start + part_size, sectors) - start
        ...
        if 'target.restrict_size' in target_overrides:
            ...
            start = Config._align_on_sector(start, sectors)
            new_size = Config._align_on_sector(start + new_size, sectors) - start
