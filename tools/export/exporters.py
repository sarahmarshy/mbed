...
class Exporter(object):
    ...
    def progen_gen_file(self, project_data):
        ...
        exporter = exporter(project_data, settings)
        self.builder_files = exporter.export_project()
        self.raw_content = exporter.PROJ_FILE_RAW
    ...
    def progen_build(self):
        ...
        result = builder(self.builder_files, ProjectSettings()).build_project()
        if result == -1:
